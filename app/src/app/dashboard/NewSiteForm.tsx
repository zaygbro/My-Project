...
export function NewSiteForm({ disabled }: { disabled: boolean }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="field-transition flex items-start gap-2 rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2.5 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/30">
        <span aria-hidden className="mt-0.5 shrink-0 font-mono text-sm font-semibold text-blue-500">
          /
        </span>
        <textarea
          id="brief"
          ...
          className="w-full resize-none bg-transparent text-base outline-none disabled:opacity-50"
        />
      </div>
